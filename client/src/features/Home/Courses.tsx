...
const postData: DataType[] = [
    ...
    {
        heading: 'Physics',
        heading2: 'Matric, Fsc &  O/A levels',
        name: "Abdullah Mukhtar",
        imgSrc: '/src/assets/images/courses/physics.jpeg',
        students: 130,
        classes: 12,
        price: 20,
        rating: 4.7,
    ...
    {
        heading: 'Arabic',
        heading2: 'with Tajweed',
        name: "Abdul Haseeb Usmani",
        imgSrc: '/src/assets/images/courses/arabic.png',
        students: 120,
        classes: 12,
        price: 20,
        rating: 4.7,
